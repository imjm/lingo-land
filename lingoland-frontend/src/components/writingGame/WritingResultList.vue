...
<template>
    <div class="scene">
        <div class="book" ref="book">
            <div
                class="page"
                :class="{ active: activePage === 1, flipped: activePage > 1 }"
            ...
            >
                ...
                <div class="back">
                    <h1>– 1 –</h1>
                    <WritingResultListItem
                        source="\src\assets\달리기.jpg"
                        text="어쩌구 저쩌구"
                    />
                </div>
            </div>
            <div
                class="page"
                :class="{ active: activePage === 2, flipped: activePage > 2 }"
                @click="handlePageClick"
            >
                <div class="front">
                    <h1>– 2 –</h1>
            ...
            <div
                class="page"
                :class="{ active: activePage === 3, flipped: activePage > 3 }"
                @click="handlePageClick"
            >
                <div class="front">
                    <h1>– 4 –</h1>
            ...
            <div
                class="page"
                :class="{ active: activePage === 4, flipped: activePage > 4 }"
                @click="handlePageClick"
            >
                <div class="front">
                    <h1>– 6 –</h1>
            ...
            <div
                class="page"
                :class="{ active: activePage === 5, flipped: activePage > 5 }"
                @click="handlePageClick"
            >
                <div class="front">
                    <h1>– 8 –</h1>
